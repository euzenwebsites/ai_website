    ...
    return (
        <section className="flex flex-col items-center px-9 z-0 mt-20 ">
            <div className="relative bg-gray-50">
                <div className="h-56 w-[970px] absolute bottom-[155px] right-[61px]">
                ...
                {!multiple && (
                    <>
                        <div className={`bg-[#d3dfe0] w-[140px] h-[140px] p-2 ${placeholder !== "" ? "cursor-pointer" : 'cursor-auto'} rounded-full h-36 w-36 absolute bottom-14 left-24 shadow-2xl drop-shadow-md`}>
                        ...
                        <div className={`bg-[#d3dfe0] w-[140px] h-[140px] p-2 ${placeholder1 !== "" ? "cursor-pointer" : 'cursor-auto'} rounded-full h-36 w-36 absolute bottom-4 left-72`}>
                            <div className="flex justify-center items-center w-full h-full">
                        ...
                        <div className={`bg-[#d3dfe0] w-[140px] h-[140px] p-2 ${placeholder3 !== "" ? "cursor-pointer" : 'cursor-auto'} rounded-full h-36 w-36 absolute bottom-3 right-72`}>
                            <div className="flex justify-center items-center w-full h-full">
            ...
            <div className="mt-10 flex flex-col justify-center items-center">
                ...
                <div className='w-[100%] flex gap-10 justify-center items-start'>
                    {condition && (
                        <div className="flex justify-center cursor-pointer items-center flex-col w-[120px]">
                            <div className='rounded-full bg-[#d3dfe0] hover:bg-[#03E2E1] transition-all duration-200'>
                                <Image width={90} height={90} src={'/contact.png'} className="w-[94px] p-2 hover:scale-150 transition-all duration-200" onClick={() => {
                    ...
                    {condition1 && (
                        <div className="flex justify-center cursor-pointer items-center flex-col w-[120px]">
                            <div className='rounded-full bg-[#d3dfe0] hover:bg-[#03E2E1] transition-all duration-200'>
                                <Image src={'/omni.png'} width={90} height={90} className="w-[94px] p-2 hover:scale-150 transition-all duration-200" onClick={() => {
