        ...
        show && <div className="bottom-0 fixed bg-white z-50 w-screen px-4 py-2">
          <div className="flex sm:flex-row flex-col justify-between items-center text-gray-500">
            <p className="sm:w-[70%] w-full">
              We use cookies to ensure you have the best experience on our site, to analyze traffic, and enhance our marketing activities. <a className="text-gray-600 underline cursor-pointer">Learn more</a>
            </p>
